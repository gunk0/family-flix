...
folder = '/Volumes/Seagate Backup Plus Drive/WATCH FOREIGN'
parent = '/Volumes/Seagate Backup Plus Drive/Flix/content/foreign'
...
for item in dirlist:
    ...
    print('         <img src="content\\foreign\%s\\img\\titlecard.jpg">'  % movs[:-1])
    print('         <div class="overlay"></div>')
    print('         </div>')
    print('         <a href="content\\foreign\%s\content.html">' % movs[:-1])
